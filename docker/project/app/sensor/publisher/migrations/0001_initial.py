...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ca_certs', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/config/../config/private'), upload_to='ca')),
                ...
                ('certfile', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/config/../config/private'), upload_to='certs')),
                ('keyfile', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/config/../config/private'), upload_to='keys')),
