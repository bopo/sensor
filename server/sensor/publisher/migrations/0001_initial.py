...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ca_certs', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/private'), upload_to='ca')),
                ('cert_reqs', models.IntegerField(choices=[(ssl.VerifyMode(2), 'Required'), (ssl.VerifyMode(1), 'Optional'), (ssl.VerifyMode(0), 'None')], default=ssl.VerifyMode(2))),
                ('tls_version', models.IntegerField(choices=[(ssl._SSLMethod(3), 'v1'), (ssl._SSLMethod(2), 'v2.3')], default=ssl._SSLMethod(3))),
                ('certfile', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/private'), upload_to='certs')),
                ('keyfile', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/Users/bopo/develop/projects/sensor/server/private'), upload_to='keys')),
